...
#undef image_variable
    ...
    // update optimize variables, e.g. the link has changed and the new unlinked variables need
    // to be added to optimize vector
...
int main(int argc, char* argv[])
{
    ...
    if (colorAnchor >= 0)
    {
        ...
        {
            HuginBase::PanoramaOptions opts = pano.getOptions();
            std::cout << "Setting color anchor to image " << colorAnchor << std::endl;
